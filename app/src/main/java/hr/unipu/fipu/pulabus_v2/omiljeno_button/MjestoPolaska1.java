...
/**
 * Fragment za mjesto polaska 1
 */
@SuppressLint("ValidFragment")
public class MjestoPolaska1 extends Fragment {
    ...
    @SuppressLint("ValidFragment")
    public MjestoPolaska1(List<String> stanice, String linija, String mjesto) {
    ...
    // metoda koja poziva adapter za iteme liste stanice za mjesto polaska 1
    @Override
